...
let EVAL_QUOTE_ENV_TAC env = fun (asm,gl) -> PURE_REWRITE_TAC[EVAL_QUOTE_CONV_ENV env gl] (asm,gl);;
...
let ASM_EVAL_QUOTE_ENV_TAC env = fun (asm,gl) -> PURE_ASM_REWRITE_TAC[EVAL_QUOTE_CONV_ENV gl] (asm,gl);;
