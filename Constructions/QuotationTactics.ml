...
let (INTERNAL_CTT_TAC : tactic) = fun (asm,gl) -> PURE_REWRITE_TAC[INTERNAL_CTT_CONV gl] (asm,gl);;
...
let (ASM_INTERNAL_CTT_TAC : tactic) = fun (asm,gl) -> PURE_ASM_REWRITE_TAC[INTERNAL_CTT_CONV gl] (asm,gl);;